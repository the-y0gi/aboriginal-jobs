      ...
      <section className="bg-[#FAF5EE] py-20 lg:py-28 relative overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <motion.div variants={stagger} initial="hidden" animate="visible" className="max-w-3xl">
            <motion.p variants={fadeUp} className="text-[#C8782A] font-semibold text-sm uppercase tracking-widest mb-4">
            ...
            <motion.p variants={fadeUp} className="text-[#6B3A2A]/75 text-lg leading-relaxed mb-8">
              Aboriginal Jobs Canada is Canada's dedicated job platform connecting First Nations, Métis, and Inuit
              job seekers with employers who are committed to inclusive, respectful hiring. We believe
              meaningful employment is a cornerstone of community wellbeing and reconciliation.
            </motion.p>
            <motion.div variants={fadeUp} className="flex flex-wrap gap-4">
              ...
              <Link href="/employers">
                <Button variant="outline" className="border-[#C8782A] text-[#C8782A] hover:bg-[#C8782A]/10 font-semibold px-7">
                  Hire with Us
                </Button>
              </Link>
            </motion.div>
      ...
      <section className="bg-[#6B3A2A] py-16 lg:py-24 relative overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            >
              <p className="text-[#C8782A] font-semibold text-sm uppercase tracking-widest mb-4">Our Mission</p>
              <h2
              ...
              <p className="text-[#FAF5EE]/70 leading-relaxed mb-5">
                Aboriginal Jobs Canada was created to address a clear need: a dedicated, respectful space where
                Indigenous job seekers can find meaningful employment and where employers can connect
                with talented Indigenous professionals.
              </p>
              <p className="text-[#FAF5EE]/70 leading-relaxed">
                We are committed to supporting the Truth and Reconciliation Commission's Calls to
                Action related to economic development and employment. Every feature of our platform
                is designed with cultural sensitivity and genuine respect for the diversity of
          ...
          >
            {values.map((v) => (
              ...
              >
                ...
                <p className="text-[#6B3A2A]/70 text-sm leading-relaxed">{v.desc}</p>
              </motion.div>
            ))}
          </motion.div>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <motion.p variants={fadeUp} className="text-[#6B3A2A]/70 max-w-2xl mx-auto leading-relaxed">
              Our team is Indigenous-led and community-driven. We bring lived experience, professional
              expertise, and deep commitment to every aspect of the platform.
            </motion.p>
          </motion.div>
      ...
      <section className="bg-white py-16 lg:py-24">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <motion.p variants={fadeUp} className="text-[#6B3A2A]/70 max-w-2xl mx-auto leading-relaxed">
              We go beyond job listings. Aboriginal Jobs Canada actively works to remove barriers, educate
              employers, and create pathways to lasting, dignified employment for Indigenous Peoples.
            </motion.p>
          </motion.div>
            ...
            {commitments.map((c) => (
              ...
              >
                ...
                <div>
                  ...
                  <p className="text-[#6B3A2A]/70 text-sm leading-relaxed">{c.desc}</p>
                </div>
              </motion.div>
            ))}
          </motion.div>
          ...
          <motion.div variants={stagger} initial="hidden" whileInView="visible" viewport={{ once: true }}>
            ...
            >
              <svg viewBox="0 0 36 36" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-8 h-8" aria-hidden="true">
                <circle cx="18" cy="18" r="16" stroke="#C8782A" strokeWidth="2" fill="none" />
                <circle cx="18" cy="18" r="10" stroke="#C8782A" strokeWidth="1.5" fill="none" opacity="0.6" />
                <circle cx="18" cy="18" r="4" fill="#C8782A" />
                <path d="M18 2 Q26 10 18 18 Q10 10 18 2Z" fill="#C8782A" opacity="0.25" />
              </svg>
            </motion.div>
            <motion.p variants={fadeUp} className="text-[#C8782A] font-semibold text-sm uppercase tracking-widest mb-4">
              Land Acknowledgement
            ...
            <motion.p variants={fadeUp} className="text-[#6B3A2A]/75 leading-relaxed text-lg">
              Aboriginal Jobs Canada respectfully acknowledges the Indigenous Peoples of Canada on whose
              traditional, ancestral, and unceded territories we work and live. We recognize the
              enduring presence of First Nations, Métis, and Inuit Peoples across Turtle Island and
              are committed to walking the path of reconciliation with humility, respect, and purpose.
            </motion.p>
          </motion.div>
        </div>
      </section>
        ...
        <div className="relative max-w-4xl mx-auto px-4 text-center">
          <motion.div variants={stagger} initial="hidden" whileInView="visible" viewport={{ once: true }}>
            <motion.h2
              ...
              style={{ fontFamily: "'Playfair Display', serif" }}
            >
              Join the CyberNest Community
            </motion.h2>
            <motion.p variants={fadeUp} className="text-white/80 mb-8 text-lg">
              Whether you're looking for work or looking to hire — CyberNest is here for you.
            </motion.p>
            <motion.div variants={fadeUp} className="flex flex-wrap gap-4 justify-center">
              <Link href="/register">
                <Button size="lg" className="bg-white text-[#C8782A] hover:bg-[#FAF5EE] font-semibold px-10">
                  Get Started Free
                </Button>
              </Link>
              <Link href="/contact">
